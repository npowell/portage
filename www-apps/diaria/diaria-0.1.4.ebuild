...
# $Header: /var/cvsroot/gentoo-x86/www-apps/diaria/diaria-0.1.4.ebuild,v 1.4 2008/01/12 07:42:22 graaff Exp $

inherit ruby

DESCRIPTION="Diaria is for posting news items to the web. "
HOMEPAGE="http://rubyforge.org/projects/diaria/"
SRC_URI="http://rubyforge.org/download.php/208/${P}.tar.gz"
LICENSE="LGPL-2.1"
USE_RUBY="any"
SLOT="0"
KEYWORDS="x86 ppc"
