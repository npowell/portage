...
# $Header: /var/cvsroot/gentoo-x86/sys-cluster/drbd-kernel/drbd-kernel-8.0.8.ebuild,v 1.3 2008/02/13 18:11:26 xmerlin Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${P/-kernel/}-missing-include.patch || die
}
