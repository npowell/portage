...
# $Header: /var/cvsroot/gentoo-x86/dev-python/pytables/pytables-2.0.2.ebuild,v 1.3 2008/06/28 19:30:55 pythonhead Exp $
...
SRC_URI="http://www.pytables.org/download/${P}/${P}.tar.gz"
